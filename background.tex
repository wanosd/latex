...
Within the scope of this application, there were a number of quality attributes that were examined.

\begin{table}[H]
\begin{itemize}
\item Security
\begin{itemize}
\item This is the capability of the system to prevent actions that are outside the designed usage, or actions that are malicious in origin.
\end{itemize}
\item Performance
\begin{itemize}
\item This is the capability of the system to respond to actions performed on it within a reasonable time frame.
\end{itemize}
\item Usability
\begin{itemize}
...
\item Extensibility
\begin{itemize}
\item This is the capability of the system to cater for future requirements.
\end{itemize}
\item Productivity
\begin{itemize}
...
These critera are based on a Yes-No answer. A Yes results in 1 point, where a No results in 0. Any exceptions are noted within the relevant tables.
